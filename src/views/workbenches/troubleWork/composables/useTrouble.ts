...
import {useTrouble as useDetailInfo} from '@/views/trouble-broken/composables';
import TroubleBrokenCheckForm from '../components/TroubleBrokenCheckForm.vue'
import SevenProofCustom from '../components/SevenProofCustom.vue'
...
export function useTrouble() {
  ...
  const activityProcess = [
    ...
    {id: 'userTask1', title: '电力设施产权人提报', status: 2},
    {id: 'userTask2', title: '执法办经办审核', status: 3},
    {id: 'userTask3', title: '执法办负责人审核', status: 4},
    {id: 'userTask4', title: '执法办经办处置', status: 5},
    {id: 'userTask5', title: '电力设施产权人核实', status: 6}
    // { id: "end", title: "归档", status: 7 }
  ];
