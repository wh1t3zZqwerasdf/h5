<template>
  <div class="contentBox">
    <FormPage ref="formPageRef" :save-btn="true" v-bind="{ ...addPageProps, ...extraData }" @onResetData="onResetData">
    </FormPage>
  </div>
</template>
<script lang="ts"  setup>
import { useRoute } from 'vue-router'
import { useTrouble, useTroubleBrokenFieldsSet } from './composables';
...
watch(
  () => _formData.value?.hiddenTroubleType,
  val => {
...
watch(
  () => _formData.value?.hiddenTroubleHarmonize,
  val => {
